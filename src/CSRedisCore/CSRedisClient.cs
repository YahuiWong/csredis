...
namespace CSRedis
{
    public partial class CSRedisClient : IDisposable
    {
        ...
        T NodesNotSupport<T>(string key, Func<Object<RedisClient>, string, T> callback)
        {
            ...
            return ExecuteScalar<T>(key, "NodesNotSupport<T>", callback);
        }
...
return 0", $"CSRedisPSubscribe{psubscribeKey}", "", trylong.ToString());
        ...
        public bool PfAdd<T>(string key, params T[] elements)
        {
            ...
            return ExecuteScalar(key, " PfAdd<T>",(c, k) => c.Value.PfAdd(k, args));
        }
        /// <summary>
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        public (T member, decimal score)[] ZPopMax<T>(string key, long count) => this.DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key, "ZPopMax<T>", (c, k) => c.Value.ZPopMaxBytes(k, count)));
        /// <summary>
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        public (T member, decimal score)[] ZPopMin<T>(string key, long count) => this.DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key, "ZPopMin<T>", (c, k) => c.Value.ZPopMinBytes(k, count)));
        ...
        /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
        /// <returns></returns>
        public T[] ZRange<T>(string key, long start, long stop) => this.DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, "ZRange<T>", (c, k) => c.Value.ZRangeBytes(k, start, stop, false)));
        /// <summary>
        ...
        /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
        /// <returns></returns>
        public (T member, decimal score)[] ZRangeWithScores<T>(string key, long start, long stop) => this.DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key, "ZRangeWithScores<T>", (c, k) => c.Value.ZRangeBytesWithScores(k, start, stop)));
        ...
        public T[] ZRangeByScore<T>(string key, decimal min, decimal max, long? count = null, long offset = 0) =>
            this.DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, "ZRangeByScore<T>", (c, k) => c.Value.ZRangeBytesByScore(k, min == decimal.MinValue ? "-inf" : min.ToString(), max == decimal.MaxValue ? "+inf" : max.ToString(), false, offset, count)));
        /// <summary>
        /// 通过分数返回有序集合指定区间内的成员
        /// </summary>
        /// <param name="key">不含prefix前辍</param>
        ...
        public (T member, decimal score)[] ZRangeByScoreWithScores<T>(string key, decimal min, decimal max, long? count = null, long offset = 0) =>
            this.DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key, "ZRangeByScoreWithScores", (c, k) => c.Value.ZRangeBytesByScoreWithScores(k, min == decimal.MinValue ? "-inf" : min.ToString(), max == decimal.MaxValue ? "+inf" : max.ToString(), offset, count)));
        /// <summary>
        /// 通过分数返回有序集合指定区间内的成员和分数
        /// </summary>
        /// <param name="key">不含prefix前辍</param>
        ...
        /// <param name="key">不含prefix前辍</param>
        /// <returns></returns>
        public T RPop<T>(string key) => this.DeserializeRedisValueInternal<T>(ExecuteScalar(key, "RPop<T>", (c, k) => c.Value.RPopBytes(k)));
        /// <summary>
        ...
        /// <param name="field">字段</param>
        /// <returns></returns>
        public T HGet<T>(string key, string field) => this.DeserializeRedisValueInternal<T>(ExecuteScalar(key, "HGet<T>", (c, k) => c.Value.HGetBytes(k, field)));
        /// <summary>
        ...
        /// <param name="key">不含prefix前辍</param>
        /// <returns></returns>
        public Dictionary<string, T> HGetAll<T>(string key) => this.DeserializeRedisValueDictionaryInternal<string, T>(ExecuteScalar(key, "HGetAll<T>", (c, k) => c.Value.HGetAllBytes(k)));
        /// <summary>
        ...
        /// <returns></returns>
        public T[] HMGet<T>(string key, params string[] fields) => fields == null || fields.Any() == false ? new T[0] : this.DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, "HMGet<T>", (c, k) => c.Value.HMGetBytes(k, fields)));
        /// <summary>
        ...
        /// <param name="key">不含prefix前辍</param>
        /// <returns></returns>
        public T[] HVals<T>(string key) => this.DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, "HVals<T>", (c, k) => c.Value.HValsBytes(k)));
        /// <summary>
        /// 迭代哈希表中的键值对
        /// </summary>
        /// <param name="key">不含prefix前辍</param>
        ...
        {
            var scan = ExecuteScalar(key, "HScan<T>", (c, k) => c.Value.HScanBytes(k, cursor, pattern, count));
        ...
        /// <param name="key">不含prefix前辍</param>
        /// <returns></returns>
        public T Get<T>(string key) => this.DeserializeRedisValueInternal<T>(ExecuteScalar(key, "Get<T>", (c, k) => c.Value.GetBytes(k)));
        /// <summary>
        /// 获取指定 key 的值（适用大对象返回）
        /// </summary>
        /// <param name="key">不含prefix前辍</param>
        ...
        /// <param name="end">结束位置，0表示第一个元素，-1表示最后一个元素</param>
        /// <returns></returns>
        public T GetRange<T>(string key, long start, long end) => this.DeserializeRedisValueInternal<T>(ExecuteScalar(key, "GetRange<T>", (c, k) => c.Value.GetRangeBytes(k, start, end)));
        /// <summary>
        ...
        {
            var args = this.SerializeRedisValueInternal(value);
            return this.DeserializeRedisValueInternal<T>(ExecuteScalar(key, "GetSet<T>", (c, k) => c.Value.GetSetBytes(k, args)));
        }
        /// <summary>
        ...
        public T[] GeoRadius<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            ExecuteScalar(key, "GeoRadius<T>", (c, k) => c.Value.GeoRadiusBytes(k, longitude, latitude, radius, unit, count, sorting, false, false, false)).Select(a => this.DeserializeRedisValueInternal<T>(a.member)).ToArray();
        ...
        public (T member, decimal dist)[] GeoRadiusWithDist<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            ExecuteScalar(key, "GeoRadiusWithDist<T>", (c, k) => c.Value.GeoRadiusBytes(k, longitude, latitude, radius, unit, count, sorting, false, true, false)).Select(a => (this.DeserializeRedisValueInternal<T>(a.member), a.dist)).ToArray();
        ...
        private (T member, decimal longitude, decimal latitude)[] GeoRadiusWithCoord<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            ExecuteScalar(key, "GeoRadiusWithCoord<T>", (c, k) => c.Value.GeoRadiusBytes(k, longitude, latitude, radius, unit, count, sorting, true, false, false)).Select(a => (this.DeserializeRedisValueInternal<T>(a.member), a.longitude, a.latitude)).ToArray();
        ...
        public (T member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusWithDistAndCoord<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            ExecuteScalar(key, "GeoRadiusWithDistAndCoord<T>", (c, k) => c.Value.GeoRadiusBytes(k, longitude, latitude, radius, unit, count, sorting, true, true, false)).Select(a => (this.DeserializeRedisValueInternal<T>(a.member), a.dist, a.longitude, a.latitude)).ToArray();
        ...
        public T[] GeoRadiusByMember<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            this.DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, "GeoRadiusByMember<T>", (c, k) => c.Value.GeoRadiusBytesByMember(k, member, radius, unit, count, sorting, false, false, false)).Select(a => a.member).ToArray());
        ...
        public (T member, decimal dist)[] GeoRadiusByMemberWithDist<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            ExecuteScalar(key, "GeoRadiusByMemberWithDist<T>", (c, k) => c.Value.GeoRadiusBytesByMember(k, member, radius, unit, count, sorting, false, true, false)).Select(a => (this.DeserializeRedisValueInternal<T>(a.member), a.dist)).ToArray();
        ...
        private (T member, decimal longitude, decimal latitude)[] GeoRadiusByMemberWithCoord<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            ExecuteScalar(key, "GeoRadiusByMemberWithCoord<T>", (c, k) => c.Value.GeoRadiusBytesByMember(k, member, radius, unit, count, sorting, true, false, false)).Select(a => (this.DeserializeRedisValueInternal<T>(a.member), a.longitude, a.latitude)).ToArray();
        ...
        public (T member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusByMemberWithDistAndCoord<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            ExecuteScalar(key, "GeoRadiusByMemberWithDistAndCoord<T>", (c, k) => c.Value.GeoRadiusBytesByMember(k, member, radius, unit, count, sorting, true, true, false)).Select(a => (this.DeserializeRedisValueInternal<T>(a.member), a.dist, a.longitude, a.latitude)).ToArray();
        #endregion
